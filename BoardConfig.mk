...
TARGET_USES_WEAVER := true
TARGET_USES_HARDWARE_QCOM_KEYMASTER := true
TARGET_USES_HARDWARE_QCOM_GATEKEEPER := true
TARGET_RECOVERY_DEVICE_MODULES += ese_weaver
RECOVERY_LIBRARY_SOURCE_FILES += $(TARGET_OUT_SHARED_LIBRARIES)/ese_weaver.so
...
TW_DEVICE_VERSION := RedmiTurbo3 | Poco F6 by grass2
